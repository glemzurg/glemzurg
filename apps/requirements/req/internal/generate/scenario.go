...
func generateScenarioSvgContents(reqs requirements.Requirements, scenario scenario.Scenario) (contents string, err error) {
...
func addSteps(eventLookup map[string]state.Event, s *svgsequence.Sequence, statements []scenario.Node, scenarioLookup map[string]scenario.Scenario, scenarioObjectLookup map[string]scenario.ScenarioObject) error {
