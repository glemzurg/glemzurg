...
func TestClassIndexListings(t *testing.T) {
	...
	listings := classIndexListings([]model_class.Attribute{
		helper.Must(model_class.NewAttribute(abbrKey, model_class.AttributeDetails{Name: "Abbr", Details: ""}, "", nil, false, model_class.AttributeAnnotations{IndexNums: []uint{0}})),
		helper.Must(model_class.NewAttribute(emailKey, model_class.AttributeDetails{Name: "Email", Details: ""}, "", nil, false, model_class.AttributeAnnotations{IndexNums: []uint{1, 3}})),
	})
