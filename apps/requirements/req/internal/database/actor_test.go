...
func (suite *ActorSuite) TestLoad() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), actor.Actor{
...
func (suite *ActorSuite) TestAdd() {
	...
	err := AddActor(suite.db, strings.ToUpper(suite.model.Key), actor.Actor{
		Key:        "KeY", // Test case-insensitive.
		Name:       "Name",
		Details:    "Details",
		Type:       "person",
...
func (suite *ActorSuite) TestUpdate() {
	...
	err := AddActor(suite.db, suite.model.Key, actor.Actor{
		Key:        "key",
		Name:       "Name",
		Details:    "Details",
		Type:       "person",
	...
	err = UpdateActor(suite.db, strings.ToUpper(suite.model.Key), actor.Actor{
		Key:        "kEy", // Test case-insensitive.
		Name:       "NameX",
		Details:    "DetailsX",
		Type:       "system",
...
func t_AddActor(t *testing.T, dbOrTx DbOrTx, modelKey, actorKey string) (actor actor.Actor) {

	err := AddActor(dbOrTx, modelKey, actor.Actor{
		Key:        actorKey,
		Name:       actorKey,
		Details:    "Details",
		Type:       "person",
