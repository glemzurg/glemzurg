...
func (suite *DomainAssociationSuite) TestLoad() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), domain.DomainAssociation{
...
func (suite *DomainAssociationSuite) TestAdd() {
	...
	err := AddDomainAssociation(suite.db, strings.ToUpper(suite.model.Key), domain.DomainAssociation{
		Key:               "KeY", // Test case-insensitive.
		ProblemDomainKey:  "domain_KEY",
		SolutionDomainKey: "doMAIN_key_b",
		UmlComment:        "UmlComment",
...
func (suite *DomainAssociationSuite) TestUpdate() {
	...
	err := AddDomainAssociation(suite.db, suite.model.Key, domain.DomainAssociation{
		Key:               "key",
		ProblemDomainKey:  "domain_key",
		SolutionDomainKey: "domain_key_b",
		UmlComment:        "UmlComment",
	...
	err = UpdateDomainAssociation(suite.db, strings.ToUpper(suite.model.Key), domain.DomainAssociation{
		Key:               "KeY",          // Test case-insensitive.
