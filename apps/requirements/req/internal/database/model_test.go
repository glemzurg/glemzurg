...
func (suite *ModelSuite) TestLoad() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), model.Model{
...
func (suite *ModelSuite) TestAdd() {
	...
	err := AddModel(suite.db, model.Model{
		Key:     "KeY", // Test case-insensitive.
		Name:    "Name",
		Details: "Details",
	})
...
func (suite *ModelSuite) TestUpdate() {
	...
	err = UpdateModel(suite.db, model.Model{
		Key:     "kEy", // Test case-insensitive.
		Name:    "NameX",
		Details: "DetailsX",
	})
...
func t_AddModel(t *testing.T, dbOrTx DbOrTx) (model model.Model) {
	err := AddModel(dbOrTx, model.Model{
		Key:     "model_key",
		Name:    "Name",
		Details: "Details",
	})
