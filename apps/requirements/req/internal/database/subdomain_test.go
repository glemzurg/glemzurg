...
func (suite *SubdomainSuite) TestLoad() {
	...
	assert.Equal(suite.T(), domain.Subdomain{
...
func (suite *SubdomainSuite) TestAdd() {
	...
	err := AddSubdomain(suite.db, strings.ToUpper(suite.model.Key), strings.ToUpper(suite.domain.Key), domain.Subdomain{
		Key:        "KeY", // Test case-insensitive.
		Name:       "Name",
		Details:    "Details",
		UmlComment: "UmlComment",
...
func (suite *SubdomainSuite) TestUpdate() {
	...
	err := AddSubdomain(suite.db, suite.model.Key, suite.domain.Key, domain.Subdomain{
		Key:        "key",
		Name:       "Name",
		Details:    "Details",
		UmlComment: "UmlComment",
	...
	err = UpdateSubdomain(suite.db, strings.ToUpper(suite.model.Key), domain.Subdomain{
		Key:        "kEy", // Test case-insensitive.
		Name:       "NameX",
		Details:    "DetailsX",
...
func (suite *SubdomainSuite) TestQuery() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), map[string][]domain.Subdomain{
		suite.domain.Key: {
			{
				Key:        "key",
				Name:       "Name",
...
func t_AddSubdomain(t *testing.T, dbOrTx DbOrTx, modelKey, domainKey string) (subdomain domain.Subdomain) {

	err := AddSubdomain(dbOrTx, modelKey, domainKey, domain.Subdomain{
		Key:        "subdomain_key",
		Name:       "Name",
		Details:    "Details",
		UmlComment: "UmlComment",
