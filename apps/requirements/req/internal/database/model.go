...
func scanModel(scanner Scanner, model *model.Model) (err error) {
	if err = scanner.Scan(
		&model.Key,
		&model.Name,
		&model.Details,
...
func LoadModel(dbOrTx DbOrTx, modelKey string) (mdl model.Model, err error) {
	...
	err = dbQueryRow(
		...
		func(scanner Scanner) (err error) {
			if err = scanModel(scanner, &mdl); err != nil {
				return err
			}
			return nil
		},
		...
		modelKey)
	if err != nil {
		return model.Model{}, errors.WithStack(err)
	}
...
func AddModel(dbOrTx DbOrTx, model model.Model) (err error) {
...
func UpdateModel(dbOrTx DbOrTx, model model.Model) (err error) {
...
func QueryModels(dbOrTx DbOrTx) (models []model.Model, err error) {
