...
func AddGeneralizations(dbOrTx DbOrTx, modelKey string, generalizations map[identity.Key][]model_class.Generalization) (err error) {
	...
	queryBuilder.WriteString(`INSERT INTO class_generalization (model_key, subdomain_key, generalization_key, name, details, unfinished_notes, is_complete, is_static, uml_comment) VALUES `)
