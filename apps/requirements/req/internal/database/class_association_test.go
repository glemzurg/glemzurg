...
func (suite *AssociationSuite) TestLoad() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), class.Association{
...
func (suite *AssociationSuite) TestAdd() {
	...
	err := AddAssociation(suite.db, strings.ToUpper(suite.model.Key), class.Association{
		Key:                 "KeY", // Test case-insensitive.
		Name:                "Name",
		Details:             "Details",
...
func (suite *AssociationSuite) TestUpdate() {
	...
	err := AddAssociation(suite.db, suite.model.Key, class.Association{
		Key:                 "key",
		Name:                "Name",
		Details:             "Details",
		FromClassKey:        "class_key",
	...
	err = UpdateAssociation(suite.db, strings.ToUpper(suite.model.Key), class.Association{
		Key:                 "KeY", // Test case-insensitive.
		Name:                "NameX",
		Details:             "DetailsX",
		FromClassKey:        "class_KEY_b", // Test case-insensitive.
		FromMultiplicity:    class.Multiplicity{LowerBound: 2, HigherBound: 3},
		ToClassKey:          "class_KEY_c", // Test case-insensitive.
		ToMultiplicity:      class.Multiplicity{LowerBound: 0, HigherBound: 1},
