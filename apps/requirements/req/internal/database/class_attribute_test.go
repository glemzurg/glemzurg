...
func (suite *AttributeSuite) TestLoad() {
	...
	assert.Equal(suite.T(), class.Attribute{
...
func (suite *AttributeSuite) TestAdd() {
	...
	err := AddAttribute(suite.db, strings.ToUpper(suite.model.Key), strings.ToUpper(suite.class.Key), class.Attribute{
		Key:              "KeY", // Test case-insensitive.
		Name:             "Name",
		Details:          "Details",
		DataTypeRules:    "DataTypeRules",
...
func (suite *AttributeSuite) TestUpdate() {
	...
	err := AddAttribute(suite.db, suite.model.Key, suite.class.Key, class.Attribute{
		Key:              "key",
		Name:             "Name",
		Details:          "Details",
		DataTypeRules:    "DataTypeRules",
	...
	err = UpdateAttribute(suite.db, strings.ToUpper(suite.model.Key), strings.ToUpper(suite.class.Key), class.Attribute{
		Key:              "KeY", // Test case-insensitive.
		Name:             "NameX",
		Details:          "DetailsX",
...
func (suite *AttributeSuite) TestQuery() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), map[string][]class.Attribute{
		"class_key": []class.Attribute{
			{
				Key:              "key",
				Name:             "Name",
				Details:          "Details",
...
func t_AddAttribute(t *testing.T, dbOrTx DbOrTx, modelKey, classKey, attributeKey string) (attribute class.Attribute) {

	err := AddAttribute(dbOrTx, modelKey, classKey, class.Attribute{
		Key:              attributeKey,
		Name:             attributeKey,
		Details:          "Details",
		DataTypeRules:    "DataTypeRules",
