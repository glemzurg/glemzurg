...
func (suite *DomainSuite) TestLoad() {
	...
	assert.Nil(suite.T(), err)
	assert.Equal(suite.T(), domain.Domain{
...
func (suite *DomainSuite) TestAdd() {
	...
	err := AddDomain(suite.db, strings.ToUpper(suite.model.Key), domain.Domain{
		Key:        "KeY", // Test case-insensitive.
		Name:       "Name",
		Details:    "Details",
		Realized:   true,
...
func (suite *DomainSuite) TestUpdate() {
	...
	err := AddDomain(suite.db, suite.model.Key, domain.Domain{
		Key:        "key",
		Name:       "Name",
		Details:    "Details",
		Realized:   true,
	...
	err = UpdateDomain(suite.db, strings.ToUpper(suite.model.Key), domain.Domain{
		Key:        "kEy", // Test case-insensitive.
		Name:       "NameX",
		Details:    "DetailsX",
		Realized:   false,
...
func t_AddDomain(t *testing.T, dbOrTx DbOrTx, modelKey string, opts ...string) (domain domain.Domain) {
	...
	err := AddDomain(dbOrTx, modelKey, domain.Domain{
		Key:        key,
		Name:       "Name",
		Details:    "Details",
		Realized:   false,
