...
func allErrorCodes() map[int]string {
	return map[int]string{
		...
		ErrTreeSubdomainAssocSubdomainNotFound: "ErrTreeSubdomainAssocSubdomainNotFound",
		ErrTreeSubdomainAssocSingleSubdomain:   "ErrTreeSubdomainAssocSingleSubdomain",
