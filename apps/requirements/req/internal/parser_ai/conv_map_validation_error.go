...
var coreToParserCode = map[coreerr.Code]int{
	...
	coreerr.ParamInvariantTypeInvalid:  ErrConvLogicTypeInvalid,
	...
	coreerr.ParamInvariantDuplicateLet:  ErrConvLogicDuplicateLet,
	...
	coreerr.AssocUniquenessInvalid:    ErrConvInternalKeyError,
