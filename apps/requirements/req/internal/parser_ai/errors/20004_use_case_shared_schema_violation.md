# Use Case Shared Schema Violation (E20004)

The use case shared JSON file does not conform to the expected schema.
...
- Run `req_check --schema use_case_shared` for the full schema
