# Named Set Schema Violation (E22004)

The named set JSON file does not conform to the expected schema.
...
- Run `req_check --schema named_set` for the full schema
