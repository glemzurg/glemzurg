...
1. Run `req_check --schema model` to see the full JSON schema
2. Compare your file against the schema requirements
3. Fix the specific violation mentioned in the error message

## File Location

The `model.json` file at the root of your model directory.
...
- Run `req_check --schema model` for the full schema
