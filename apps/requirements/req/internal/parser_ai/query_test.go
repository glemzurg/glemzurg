...
const (
	t_QUERY_PATH_OK  = "test_files/query"
	t_QUERY_PATH_ERR = t_QUERY_PATH_OK + "/err"
)
...
func (suite *QuerySuite) TestParseQueryErrors() {
	testDataFiles, err := t_ContentsForAllErrorJSONFiles(t_QUERY_PATH_ERR)
	if err != nil {
