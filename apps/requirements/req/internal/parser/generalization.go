...
func parseGeneralization(key, filename, contents string) (generalization class.Generalization, err error) {
	...
	generalization, err = class.NewGeneralization(key, parsedFile.Title, parsedFile.Markdown, isComplete, isStatic, parsedFile.UmlComment)
	if err != nil {
		return class.Generalization{}, err
	}
...
func generateGeneralizationContent(generalization class.Generalization) string {
	yamlStr := ""
