...
// TODO: TestClassSuite needs updating for new model types (DerivationPolicy is now *model_logic.Logic,
// event parameters changed, action requires/guarantees are now []model_logic.Logic,
// generalization key type changed to cgeneralization, etc.)
