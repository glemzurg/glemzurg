...
// ToRequirements converts the scenarioInOut to scenario.Scenario.
func (s scenarioInOut) ToRequirements() scenario.Scenario {
...
// FromRequirementsScenario creates a scenarioInOut from scenario.Scenario.
func FromRequirementsScenario(s scenario.Scenario) scenarioInOut {
