...
// ToRequirements converts the useCaseInOut to use_case.UseCase.
func (u useCaseInOut) ToRequirements() use_case.UseCase {
	...
	for k, v := range u.Actors {
		if useCase.Actors == nil {
			useCase.Actors = make(map[string]use_case.UseCaseActor)
		}
...
// FromRequirementsUseCase creates a useCaseInOut from use_case.UseCase.
func FromRequirementsUseCase(u use_case.UseCase) useCaseInOut {
