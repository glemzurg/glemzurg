...
func allCodeConstants() map[string]Code {
	return map[string]Code{
		...
		"LogicDestroySelectionRequired":      LogicDestroySelectionRequired,
		"LogicDestroyEventRequired":          LogicDestroyEventRequired,
		...
		"ParamInvariantDuplicateLet": ParamInvariantDuplicateLet,
		...
		"ClassGuaranteeDestroyTargetInvalid": ClassGuaranteeDestroyTargetInvalid,
		"ClassFacetofInvalid":                ClassFacetofInvalid,
		"ClassFacetofTypeInvalid":            ClassFacetofTypeInvalid,
		"ClassFacetofSelf":                   ClassFacetofSelf,
		"ClassFacetofNotfound":               ClassFacetofNotfound,
		...
		"AssocUniquenessScopeInvalid":     AssocUniquenessScopeInvalid,
		"AssocUniquenessKeyRequired":      AssocUniquenessKeyRequired,
		"AssocUniquenessMaxInvalid":       AssocUniquenessMaxInvalid,
		"AssocUniquenessDuplicate":        AssocUniquenessDuplicate,
		"AssocUniquenessFromAttrNotfound": AssocUniquenessFromAttrNotfound,
		"AssocUniquenessToAttrNotfound":   AssocUniquenessToAttrNotfound,
		...
		"SstepDestroyFromRequired":    SstepDestroyFromRequired,
		"SstepDestroyToForbidden":     SstepDestroyToForbidden,
		"SstepDestroyKeysForbidden":   SstepDestroyKeysForbidden,
