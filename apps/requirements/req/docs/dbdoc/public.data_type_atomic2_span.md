...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| data_type_id | bigint |  | false |  | [public.data_type_atomic2](public.data_type_atomic2.md) | The atomic data type this is a span for. |
...
| ---- | ---- | ---------- |
| fk_span_atomic | FOREIGN KEY | FOREIGN KEY (data_type_id) REFERENCES data_type_atomic2(data_type_id) ON DELETE CASCADE |
| data_type_atomic2_span_pkey | PRIMARY KEY | PRIMARY KEY (data_type_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| data_type_atomic2_span_pkey | CREATE UNIQUE INDEX data_type_atomic2_span_pkey ON public.data_type_atomic2_span USING btree (data_type_id) |

## Relations

![er](public.data_type_atomic2_span.svg)
