...
| [public.event](public.event.md) | 5 | Some occurrence that can potentially trigger a change in an instance. | BASE TABLE |
| [public.event_parameter](public.event_parameter.md) | 5 | An ordered parameter name carried by an event payload. | BASE TABLE |
...
| [public.use_case_generalization](public.use_case_generalization.md) | 9 | A relationship between use cases indicating super classes and subclasses. | BASE TABLE |
| [public.use_case](public.use_case.md) | 11 | A sequence of steps in the business rules. | BASE TABLE |
