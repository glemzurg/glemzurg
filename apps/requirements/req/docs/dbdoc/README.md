...
| [public.logic](public.logic.md) | 6 | A bit of business logic. | BASE TABLE |
...
| [public.action_parameter](public.action_parameter.md) | 7 | A parameter of an action. | BASE TABLE |
