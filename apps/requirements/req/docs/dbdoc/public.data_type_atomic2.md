...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| data_type_id | integer | nextval('data_type_atomic2_data_type_id_seq'::regclass) | false | [public.data_type_atomic2_span](public.data_type_atomic2_span.md) [public.data_type_atomic2_enum_value](public.data_type_atomic2_enum_value.md) [public.data_type2](public.data_type2.md) |  | The internal ID. |
...
| ---- | ---- | ---------- |
| data_type_atomic2_pkey | PRIMARY KEY | PRIMARY KEY (data_type_id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| data_type_atomic2_pkey | CREATE UNIQUE INDEX data_type_atomic2_pkey ON public.data_type_atomic2 USING btree (data_type_id) |

## Relations

![er](public.data_type_atomic2.svg)
