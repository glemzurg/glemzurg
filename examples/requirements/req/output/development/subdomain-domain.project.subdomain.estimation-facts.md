...
- each Estimate Historic (belongs to family) links to exactly one Process::Family::Family; each Process::Family::Family may link to any number of Estimate Historics (Family copied from the estimate this snapshot belongs to.).
...
- each Process::Family::Family (has estimates) links to any number of Estimates; each Estimate links to exactly one Process::Family::Family (Size and time estimates recorded in this family.).
