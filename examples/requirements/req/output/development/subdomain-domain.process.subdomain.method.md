...
Design templates used when planning a project or module.
## Classes
...
- **[Design Method](class-domain.process.subdomain.method.class.design_method.md).** A design template used when planning a project or module.
...
[Model facts](subdomain-domain.process.subdomain.method-facts.md)
