...
- each Defect (injected in phase) links to exactly one Process::Definition::Phase; each Process::Definition::Phase may link to any number of Defects (Phase where this defect was injected.).
...
- each Defect (removed in phase) links to exactly one Process::Definition::Phase; each Process::Definition::Phase may link to any number of Defects (Phase where this defect was removed.).
...
- each Issue (injected in phase) links to exactly one Process::Definition::Phase; each Process::Definition::Phase may link to any number of Issues (Phase where this issue was found.).
...
- each Process Improvement Proposal (on phase) links to exactly one Process::Definition::Phase; each Process::Definition::Phase may link to any number of Process Improvement Proposals (Phase this proposal is about.).
