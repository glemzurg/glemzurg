...
| ---- | ----- | -------- | ---- | --------------------- |
| Axis | _(unparsed)_ enum of size, time | false |  | Whether this estimate is of size or time. |
| Scope | _(unparsed)_ enum of project, phase, cycle, proxy, added, modified, deleted | false |  | How the estimate is categorized. |
| Version | _(unparsed)_ [1 .. unconstrained] at 1 unit | false |  | Increments as the estimate is updated. Defaults to 1. |
...
- The language of an estimate belongs to the same family as the estimate.
    - **LET lang == CHOOSE l ∈ self.UsesLanguage : TRUE IN LET family == CHOOSE f ∈ self._HasEstimates : TRUE IN lang ∈ family.HasLanguages**
...
style class_domain_project_subdomain_estimation_class_estimate stroke:#9370DB,stroke-width:3px
