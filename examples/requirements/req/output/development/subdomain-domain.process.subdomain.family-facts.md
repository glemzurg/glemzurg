...
- each Family (has estimates) links to any number of Project::Estimation::Estimates; each Project::Estimation::Estimate links to exactly one Family (Size and time estimates recorded in this family.).
...
- each Project::Estimation::Estimate Historic (belongs to family) links to exactly one Family; each Family may link to any number of Project::Estimation::Estimate Historics (Family copied from the estimate this snapshot belongs to.).
