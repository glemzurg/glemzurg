...
- **[Cancel Order](use_case-01_order_fulfillment.cancel_order.md).** The Customer has changed their mind about a Book Order after placing it and wants 
to cancel.
...
- **[Check Out](use_case-01_order_fulfillment.check_out.md).** The Customer has decided to proceed to checkout (i.e. place their Book Order).
